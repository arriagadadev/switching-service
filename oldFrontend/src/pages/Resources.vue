  ...
  <q-page class="q-pa-md">
    ...
    <q-card class="q-mb-md" flat bordered>
      <q-card-section class="q-pa-md">
        <div class="row resources-filters q-col-gutter-md">
          ...
          <div class="col-12 col-sm-6 col-md-3 q-mb-sm q-mb-md-none filter-select">
            <q-select
              v-model="filterType"
            ...
            >
              <template v-slot:selected>
                <span v-if="filterType" class="filter-selected-text">
          ...
          <div class="col-12 col-sm-6 col-md-3 q-mb-sm q-mb-md-none filter-select">
            ...
            >
              <template v-slot:selected>
                <span v-if="filterState !== null" class="filter-selected-text">
                  {{ stateFilterOptions.find(o => o.value === filterState)?.label }}
                </span>
              </template>
            </q-select>
          </div>
          <div class="col-12 col-md-2 col-lg-2 resources-filters-actions">
...
.filter-select-input :deep(.q-field__control-container) {
  min-width: 0;
  padding-right: 56px;
}

.filter-select-input :deep(.q-field__native),
.filter-select-input :deep(.q-field__input) {
  min-width: 0;
  padding-right: 4px;
}

.filter-select-input :deep(.q-field__control) {
  min-height: 40px;
}
